 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_siyavulaqt_question_test extends advanced_testcase {
    public function test_is_complete_response() {
        $question = test_question_maker::make_question('siyavulaqt', 'true');
    ...
    public function test_get_question_summary() {
        $tf = test_question_maker::make_question('siyavulaqt', 'true');
    ...
    public function test_summarise_response() {
        ...
        $this->assertEquals(get_string('false', 'qtype_siyavulaqt'),
                $tf->summarise_response(array('answer' => '0')));

        $this->assertEquals(get_string('true', 'qtype_siyavulaqt'),
    ...
    public function test_classify_response() {
        ...
        $this->assertEquals(array(
                $tf->id => new question_classified_response(
                        0, get_string('false', 'qtype_siyavulaqt'), 0.0)),
                $tf->classify_response(array('answer' => '0')));
        $this->assertEquals(array(
                $tf->id => new question_classified_response(
                        1, get_string('true', 'qtype_siyavulaqt'), 1.0)),
