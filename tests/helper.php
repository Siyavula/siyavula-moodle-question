...
/**
 * Test helpers for the siyavulaqt question type.
 *
 * @package    qtype
...
/**
 * Test helper class for the siyavulaqt question type.
 *
 * @copyright  2011 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_siyavulaqt_test_helper extends question_test_helper {
    public function get_test_questions() {
        return array('true', 'false');
    }

    /**
     * Makes a siyavulaqt question with correct answer true.
     * @return qtype_siyavulaqt_question
     */
    public function make_siyavulaqt_question_true() {
        question_bank::load_question_definition_classes('siyavulaqt');
        $tf = new qtype_siyavulaqt_question();
        ...
        $tf->penalty = 1;
        $tf->qtype = question_bank::get_qtype('siyavulaqt');
    ...
    public function get_siyavulaqt_question_form_data_true() {
    ...
    function get_siyavulaqt_question_data_true() {
    ...
    /**
     * Makes a siyavulaqt question with correct answer false.
     * @return qtype_siyavulaqt_question
     */
    public function make_siyavulaqt_question_false() {
        question_bank::load_question_definition_classes('siyavulaqt');
        $tf = new qtype_siyavulaqt_question();
        test_question_maker::initialise_a_question($tf);
        $tf->name = 'True/false question';
