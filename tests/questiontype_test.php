...
global $CFG;
require_once($CFG->dirroot . '/question/type/siyavulaqt/questiontype.php');
require_once($CFG->dirroot . '/question/engine/tests/helpers.php');
require_once($CFG->dirroot . '/question/type/edit_question_form.php');
require_once($CFG->dirroot . '/question/type/siyavulaqt/edit_siyavulaqt_form.php');
...
class qtype_siyavulaqt_test extends advanced_testcase {
    ...
    protected function setUp() {
        $this->qtype = new qtype_siyavulaqt();
    }
    ...
    public function test_name() {
        $this->assertEquals($this->qtype->name(), 'siyavulaqt');
    }
    ...
    public function test_get_possible_responses() {
        ...
        $this->assertEquals(array(
            $q->id => array(
                0 => new question_possible_response(get_string('false', 'qtype_siyavulaqt'), 0),
                1 => new question_possible_response(get_string('true', 'qtype_siyavulaqt'), 1),
    ...
    public function test_question_saving_true() {
        ...
        $questiondata = test_question_maker::get_question_data('siyavulaqt');
        $formdata = test_question_maker::get_question_form_data('siyavulaqt');

        $generator = $this->getDataGenerator()->get_plugin_generator('core_question');
        $cat = $generator->create_question_category(array());

        $formdata->category = "{$cat->id},{$cat->contextid}";
        qtype_siyavulaqt_edit_form::mock_submit((array)$formdata);

        $form = qtype_siyavulaqt_test_helper::get_question_editing_form($cat, $questiondata);
