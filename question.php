...
class qtype_siyavulaqt_question extends question_graded_automatically {
    ...
    public function summarise_response(array $response) {
        if (!array_key_exists('answer', $response)) {
            ...
            return get_string('true', 'qtype_siyavulaqt');
        } else {
            return get_string('false', 'qtype_siyavulaqt');
        }
    }

    public function un_summarise_response(string $summary) {
        if ($summary === get_string('true', 'qtype_siyavulaqt')) {
            return ['answer' => '1'];
        } else if ($summary === get_string('false', 'qtype_siyavulaqt')) {
            return ['answer' => '0'];
        } else {
            return [];
        }
    ...
    public function get_validation_error(array $response) {
        ...
        return get_string('pleaseselectananswer', 'qtype_siyavulaqt');
    }
