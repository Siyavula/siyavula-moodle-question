...
class qtype_siyavulaqt extends question_type {
    public function save_question_options($question) {
        ...
        // Save question options in question_siyavulaqt table.
        if ($options = $DB->get_record('question_siyavulaqt', array('question' => $question->id))) {
            ...
            $options->trueanswer  = $trueid;
            $options->falseanswer = $falseid;
            $DB->insert_record('question_siyavulaqt', $options);
        }
    ...
    public function delete_question($questionid, $contextid) {
        global $DB;
        $DB->delete_records('question_siyavulaqt', array('question' => $questionid));
